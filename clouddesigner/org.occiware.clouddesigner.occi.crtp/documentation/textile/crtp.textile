h1. OCCI Component Resource Templates Profile
...
| occi.compute.cores |  | false | true | 1 | Number of CPU cores assigned to the instance |
| occi.compute.memory |  | false | true | 1.0 | Maximum RAM in gigabytes allocated to the instance |
...
| *Attribute* | *Type* | *Required* | *Mutable* | *Default* | *Description* |
| occi.compute.cores |  | false | true | 2 | Number of CPU cores assigned to the instance |
| occi.compute.memory |  | false | true | 2.0 | Maximum RAM in gigabytes allocated to the instance |
...
| *Attribute* | *Type* | *Required* | *Mutable* | *Default* | *Description* |
| occi.compute.cores |  | false | true | 4 | Number of CPU cores assigned to the instance |
| occi.compute.memory |  | false | true | 4.0 | Maximum RAM in gigabytes allocated to the instance |
...
| *Attribute* | *Type* | *Required* | *Mutable* | *Default* | *Description* |
| occi.compute.cores |  | false | true | 2 | Number of CPU cores assigned to the instance |
| occi.compute.memory |  | false | true | 8.0 | Maximum RAM in gigabytes allocated to the instance |
| occi.compute.ephemeral_storage.size | <a href="infrastructure.textile#datatype-gib">GiB</a> | true | false | 20.0 | Ephemeral storage provisioned for the associated Compute instance |
...
| *Attribute* | *Type* | *Required* | *Mutable* | *Default* | *Description* |
| occi.compute.cores |  | false | true | 4 | Number of CPU cores assigned to the instance |
| occi.compute.memory |  | false | true | 16.0 | Maximum RAM in gigabytes allocated to the instance |
| occi.compute.ephemeral_storage.size | <a href="infrastructure.textile#datatype-gib">GiB</a> | true | false | 40.0 | Ephemeral storage provisioned for the associated Compute instance |


Generated at Thu Jun 09 15:51:54 CEST 2016 from platform:/resource/org.occiware.clouddesigner.occi.crtp/model/crtp.occie by org.occiware.clouddesigner.occi.gen.doc
