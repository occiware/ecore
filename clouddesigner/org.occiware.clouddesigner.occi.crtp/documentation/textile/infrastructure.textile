h1. OCCI Infrastructure Extension 1.2
...
| occi.network.vlan | <a href="infrastructure.textile#datatype-vlanid">VlanId</a> | false | true |  | 802.1q VLAN Identifier (e.g., 343) |
...
| occi.compute.hostname | <a href="infrastructure.textile#datatype-hostname">HostName</a> | false | true |  | Fully Qualified DNS hostname for the instance |
...
| occi.networkinterface.mac | <a href="infrastructure.textile#datatype-macaddress">MacAddress</a> | true | true |  | MAC address associated with the link's device interface |
...
Enumeration of suspend methods:
* hibernate  
* suspend  

h2. Datatype VlanId

Data type for 802.1q VLAN identifiers.
...
Data type for tag based VLANs (e.g., external-dmz).

Base type: java.lang.String
* pattern = [a-fA-F][0-9a-fA-F-]*[0-9a-fA-F]
...
Enumeration of NetworkInterface status:
* active  
* inactive  
* error  
...
Enumeration of restart methods:
* graceful  
* warm  
* cold  
...
Data type for Internet Protocol (IP) network addresses (e.g., 192.168.0.1, fc00::).
...
Address allocation mechanism: dynamic uses the dynamic host configuration protocol, static uses user supplied static network configurations:
* dynamic  
* static  

h2. Enum StorageStatus

Enumeration of Storage status:
* online  
* offline  
* error  
...
Enumeration of StorageLink status:
* active  
* inactive  
* error  
...
Data type for numbers of cores.
...
Data type for Internet Protocol (IP) network addresses (e.g., 192.168.0.1/24, fc00::/7).

Base type: java.lang.String
* pattern = (([0-9A-Fa-f]{1,4}:){7}[0-9A-Fa-f]{1,4}|(\d{1,3}\.){3}\d{1,3})\/(\d{1}|[0-2]{1}\d{1}|3[0-2])

h2. Datatype MacAddress

Data type for MAC addresses.
...
Data type for relative numbers of CPU shares.
...
Enumeration of save methods:
* hot  
* deferred  

h2. Datatype HostName

Data type for host names.

Base type: java.lang.String
* pattern = ^([a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,6}$

Generated at Thu Jun 09 15:51:54 CEST 2016 from http://schemas.ogf.org/occi/infrastructure by org.occiware.clouddesigner.occi.gen.doc
