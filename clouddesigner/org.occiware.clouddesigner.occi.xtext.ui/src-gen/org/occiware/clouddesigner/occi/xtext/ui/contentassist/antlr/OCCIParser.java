		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEEnumAccess().getGroup_5_3(), "rule__EEnum__Group_5_3__0");
					...
					put(grammarAccess.getMixinAccess().getDependsAssignment_6_2(), "rule__Mixin__DependsAssignment_6_2");
					put(grammarAccess.getMixinAccess().getDependsAssignment_6_3_1(), "rule__Mixin__DependsAssignment_6_3_1");
					put(grammarAccess.getMixinAccess().getAppliesAssignment_7_2(), "rule__Mixin__AppliesAssignment_7_2");
					put(grammarAccess.getMixinAccess().getAppliesAssignment_7_3_1(), "rule__Mixin__AppliesAssignment_7_3_1");
					put(grammarAccess.getMixinAccess().getAttributesAssignment_8_2(), "rule__Mixin__AttributesAssignment_8_2");
					put(grammarAccess.getMixinAccess().getAttributesAssignment_8_3_1(), "rule__Mixin__AttributesAssignment_8_3_1");
					put(grammarAccess.getMixinAccess().getActionsAssignment_9_2(), "rule__Mixin__ActionsAssignment_9_2");
					put(grammarAccess.getMixinAccess().getActionsAssignment_9_3_1(), "rule__Mixin__ActionsAssignment_9_3_1");
					...
					put(grammarAccess.getEEnumAccess().getInstanceTypeNameAssignment_4_1(), "rule__EEnum__InstanceTypeNameAssignment_4_1");
					put(grammarAccess.getEEnumAccess().getELiteralsAssignment_5_2(), "rule__EEnum__ELiteralsAssignment_5_2");
					put(grammarAccess.getEEnumAccess().getELiteralsAssignment_5_3_1(), "rule__EEnum__ELiteralsAssignment_5_3_1");
					...
					put(grammarAccess.getEDataType_ImplAccess().getInstanceTypeNameAssignment_4_1(), "rule__EDataType_Impl__InstanceTypeNameAssignment_4_1");
