...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>cloud</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class CloudExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(CloudPackage.eNS_URI, 
			 CloudPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.cloud"));
				Machine root = CloudFactory.eINSTANCE.createMachine();
