...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>linkeddata</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkeddataExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(LinkeddataPackage.eNS_URI, 
			 LinkeddataPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.linkeddata"));
				Ldproject root = LinkeddataFactory.eINSTANCE.createLdproject();
