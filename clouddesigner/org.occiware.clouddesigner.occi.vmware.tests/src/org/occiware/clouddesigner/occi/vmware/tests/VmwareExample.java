...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>vmware</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class VmwareExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(VmwarePackage.eNS_URI, 
			 VmwarePackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				...
				Datastore root = VmwareFactory.eINSTANCE.createDatastore();
