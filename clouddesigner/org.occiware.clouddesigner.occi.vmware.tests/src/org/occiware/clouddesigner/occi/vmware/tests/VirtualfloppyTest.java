...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Virtualfloppy</b></em>'.
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualfloppyTest extends TestCase {
	...
	public static void main(String[] args) {
		TestRunner.run(VirtualfloppyTest.class);
	}

	/**
	 * Constructs a new Virtualfloppy test case with the given name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public VirtualfloppyTest(String name) {
		super(name);
	}
	...
	protected void setUp() throws Exception {
		setFixture(VmwareFactory.eINSTANCE.createVirtualfloppy());
	}
