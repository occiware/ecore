...
public class Generate extends AbstractAcceleoGenerator {
	...
	public void registerPackages(ResourceSet resourceSet) {
		...
		resourceSet.getPackageRegistry().put(OCCIPackage.eINSTANCE.eNS_URI,
				OCCIPackage.eINSTANCE);
		resourceSet.getPackageRegistry().put(
				InfrastructurePackage.eINSTANCE.eNS_URI,
				InfrastructurePackage.eINSTANCE);
		resourceSet.getPackageRegistry().put(DockerPackage.eINSTANCE.eNS_URI,
