...
curl $CURL_OPTS -X PUT $OCCI_SERVER_URL/machine_VirtualBox/_uEZL8H6gEeWnDLHK1wRq-g -H 'Content-Type: text/occi' -H 'Category: machine_VirtualBox; scheme="http://occiware.org/docker#"; class="kind";' -H 'X-OCCI-Attribute: name="OCCIware"'
curl $CURL_OPTS -X PUT $OCCI_SERVER_URL/container/_8QFOkH6gEeWnDLHK1wRq-g -H 'Content-Type: text/occi' -H 'Category: container; scheme="http://occiware.org/docker#"; class="kind";' -H 'X-OCCI-Attribute: name="erocci"' -H 'X-OCCI-Attribute: image="erocci/erocci"' -H 'X-OCCI-Attribute: ports="8080:80"' -H 'X-OCCI-Attribute: volumes="`pwd`/config/erocci:/tmp"' -H 'X-OCCI-Attribute: working_dir=""' -H 'X-OCCI-Attribute: expose=""'
