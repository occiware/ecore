...
public class LinkImpl extends EntityImpl implements Link {
	...
	public boolean LinkKindIsInParent(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		 ...
		 *       in
		 *         'Link::LinkKindIsInParent'.logDiagnostic(self, diagnostics, context, severity, status, 0)
		 *     endif
		 */
		...
		final /*@NonNull*/ /*@NonInvalid*/ IntegerValue severity_0 = ClassUtil.nonNullState(CGStringGetSeverityOperation.INSTANCE.evaluate(evaluator, OCCITables.STR_Link_c_c_LinkKindIsInParent));
		...
		if (le) {
		    ...
		    final /*@NonInvalid*/ boolean logDiagnostic = ClassUtil.nonNullState(CGStringLogDiagnosticOperation.INSTANCE.evaluate(evaluator, org.eclipse.ocl.pivot.ids.TypeId.BOOLEAN, OCCITables.STR_Link_c_c_LinkKindIsInParent, this, diagnostics, context, severity_0, CAUGHT_status, OCCITables.INT_0).booleanValue());
