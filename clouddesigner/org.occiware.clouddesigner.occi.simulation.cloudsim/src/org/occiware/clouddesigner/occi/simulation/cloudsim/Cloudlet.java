...
public class Cloudlet {
	...
	public String toString(){
		...
		return "< cloudletId "+cloudletId+", cloudletLength "+cloudletLength+", pesNumber "
		+numberOfPes+", cloudletFileSize "+cloudletFileSize+", cloudletOutputSize "+cloudletOutputSize;
	}
