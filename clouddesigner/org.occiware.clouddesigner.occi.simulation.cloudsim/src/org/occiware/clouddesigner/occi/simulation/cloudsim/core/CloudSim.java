...
import org.occiware.clouddesigner.occi.simulation.cloudsim.core.predicates.Predicate;
import org.occiware.clouddesigner.occi.simulation.cloudsim.core.predicates.PredicateAny;
import org.occiware.clouddesigner.occi.simulation.cloudsim.core.predicates.PredicateNone;
...
public class CloudSim {
	...
	public static void send(int src, int dest, double delay, int tag, Object data) {
		...
		e.CustomtoString("CloudSim (futur queue event added) \n");
		future.addEvent(e);
	}
