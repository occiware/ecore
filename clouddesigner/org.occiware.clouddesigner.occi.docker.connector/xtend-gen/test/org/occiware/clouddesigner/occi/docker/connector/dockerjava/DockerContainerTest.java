...
public class DockerContainerTest {
  ...
  public static Map<DockerClient, CreateContainerResponse> containerCreate(final DockerAspect instanceAspect, final String testImage, final Machine_VirtualBox machine) {
    ...
    ArrayListMultimap<String, String> _create = ArrayListMultimap.<String, String>create();
    Map<DockerClient, CreateContainerResponse> map = ContainerAspect.createContainer(instanceAspect.container, newmachine, _create);
