...
public class BlkioManager {
  public void setReadValue(final String host, final String privateKey, final Container container, final String value) {
  ...
  public void setWriteValue(final String host, final String privateKey, final Container container, final String value) {
    boolean _isInteger = DockerUtil.isInteger(value);
    if (_isInteger) {
      boolean _equals = value.equals("-1");
      if (_equals) {
