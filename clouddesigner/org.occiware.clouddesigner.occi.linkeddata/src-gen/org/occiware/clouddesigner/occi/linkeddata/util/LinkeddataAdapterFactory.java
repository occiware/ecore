...
public class LinkeddataAdapterFactory extends AdapterFactoryImpl {
	...
	protected LinkeddataSwitch<Adapter> modelSwitch =
		new LinkeddataSwitch<Adapter>() {
			...
			@Override
			public Adapter caseLdcontains(Ldcontains object) {
				return createLdcontainsAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.occiware.clouddesigner.occi.linkeddata.Ldcontains <em>Ldcontains</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
