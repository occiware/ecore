...
one sig extension extends Extension {} {
    ...
    kinds = ldproject + lddatabaselink + ldprojectlink + ldnode + ldcontains
    no mixins
...
one sig ldcontains extends Kind {} {
    term = "ldcontains"
    scheme = "http://occiware.org/linkeddata#"
    no title
    parent = core/link
    no attributes
    no actions
    entities in Ldcontains
}

// ======================================================================
// Signature for Ldcontains
// ======================================================================

sig Ldcontains extends core/Link {
} {
    hasKind[ldcontains]
}
