...
/**
 * This is the item provider adapter for a {@link org.occiware.clouddesigner.occi.vmware.Virtualfloppy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualfloppyItemProvider extends StorageItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VirtualfloppyItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Virtualfloppy_volumeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Virtualfloppy_volumeName_feature", "_UI_Virtualfloppy_type"),
				 VmwarePackage.eINSTANCE.getVirtualfloppy_VolumeName(),
				 true,
				 false,
				 false,
	...
	/**
	 * This returns Virtualfloppy.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Virtualfloppy"));
	}
	...
	public String getText(Object object) {
		String label = ((Virtualfloppy)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Virtualfloppy_type") :
			getString("_UI_Virtualfloppy_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Virtualfloppy.class)) {
