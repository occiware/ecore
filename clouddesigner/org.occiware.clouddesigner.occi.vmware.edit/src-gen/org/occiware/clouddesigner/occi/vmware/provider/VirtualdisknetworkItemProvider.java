...
/**
 * This is the item provider adapter for a {@link org.occiware.clouddesigner.occi.vmware.Virtualdisknetwork} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualdisknetworkItemProvider extends StorageItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VirtualdisknetworkItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Virtualdisknetwork_volumeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Virtualdisknetwork_volumeName_feature", "_UI_Virtualdisknetwork_type"),
				 VmwarePackage.eINSTANCE.getVirtualdisknetwork_VolumeName(),
				 true,
				 false,
				 false,
	...
	/**
	 * This returns Virtualdisknetwork.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Virtualdisknetwork"));
	}
	...
	public String getText(Object object) {
		String label = ((Virtualdisknetwork)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Virtualdisknetwork_type") :
			getString("_UI_Virtualdisknetwork_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Virtualdisknetwork.class)) {
			case VmwarePackage.VIRTUALDISKNETWORK__VOLUME_NAME:
