...
/**
 * This is the item provider adapter for a {@link org.occiware.clouddesigner.occi.vmware.Cluster} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClusterItemProvider extends ResourceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VmwarePackage.eINSTANCE.getCluster_Name(),
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Cluster.class)) {
			case VmwarePackage.CLUSTER__NAME:
