...
/**
 * This is the item provider adapter for a {@link org.occiware.clouddesigner.occi.vmware.Datacenter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatacenterItemProvider extends ResourceItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDefaultHardwareVersionKeyPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Default Hardware Version Key feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDefaultHardwareVersionKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Datacenter_defaultHardwareVersionKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Datacenter_defaultHardwareVersionKey_feature", "_UI_Datacenter_type"),
				 VmwarePackage.eINSTANCE.getDatacenter_DefaultHardwareVersionKey(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VmwarePackage.eINSTANCE.getDatacenter_Name(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
