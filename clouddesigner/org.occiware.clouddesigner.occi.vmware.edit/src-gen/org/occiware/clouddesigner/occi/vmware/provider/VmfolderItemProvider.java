...
/**
 * This is the item provider adapter for a {@link org.occiware.clouddesigner.occi.vmware.Vmfolder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VmfolderItemProvider extends ResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VmfolderItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Vmfolder_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Vmfolder_name_feature", "_UI_Vmfolder_type"),
				 VmwarePackage.eINSTANCE.getVmfolder_Name(),
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Vmfolder"));
	}
	...
	public String getText(Object object) {
		String label = ((Vmfolder)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Vmfolder_type") :
			getString("_UI_Vmfolder_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Vmfolder.class)) {
			case VmwarePackage.VMFOLDER__NAME:
