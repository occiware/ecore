...
/**
 * This is the item provider adapter for a {@link org.occiware.clouddesigner.occi.vmware.Hostfolder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HostfolderItemProvider extends ResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HostfolderItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hostfolder_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hostfolder_name_feature", "_UI_Hostfolder_type"),
				 VmwarePackage.eINSTANCE.getHostfolder_Name(),
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Hostfolder"));
	}
	...
	public String getText(Object object) {
		String label = ((Hostfolder)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Hostfolder_type") :
			getString("_UI_Hostfolder_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Hostfolder.class)) {
			case VmwarePackage.HOSTFOLDER__NAME:
