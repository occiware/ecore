...
/**
 * This is the item provider adapter for a {@link org.occiware.clouddesigner.occi.vmware.Virtualcdrom} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VirtualcdromItemProvider extends StorageItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VirtualcdromItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsoFilenamePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Iso Filename feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsoFilenamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Virtualcdrom_isoFilename_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Virtualcdrom_isoFilename_feature", "_UI_Virtualcdrom_type"),
				 VmwarePackage.eINSTANCE.getVirtualcdrom_IsoFilename(),
				 true,
				 false,
				 false,
	...
	protected void addVolumeNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Virtualcdrom_volumeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Virtualcdrom_volumeName_feature", "_UI_Virtualcdrom_type"),
				 VmwarePackage.eINSTANCE.getVirtualcdrom_VolumeName(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Virtualcdrom"));
	}
	...
	public String getText(Object object) {
		String label = ((Virtualcdrom)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Virtualcdrom_type") :
			getString("_UI_Virtualcdrom_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Virtualcdrom.class)) {
