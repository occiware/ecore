...
/**
 * This is the item provider adapter for a {@link org.occiware.clouddesigner.occi.vmware.Vswitch} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VswitchItemProvider extends NetworkItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addBeaconIntervalPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Vswitch_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Vswitch_name_feature", "_UI_Vswitch_type"),
				 VmwarePackage.eINSTANCE.getVswitch_Name(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VmwarePackage.eINSTANCE.getVswitch_Nbport(),
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Beacon Interval feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addBeaconIntervalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Vswitch_beaconInterval_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Vswitch_beaconInterval_feature", "_UI_Vswitch_type"),
				 VmwarePackage.eINSTANCE.getVswitch_BeaconInterval(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addMtuPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Vswitch_mtu_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Vswitch_mtu_feature", "_UI_Vswitch_type"),
				 VmwarePackage.eINSTANCE.getVswitch_Mtu(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addChangeOperationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Vswitch_changeOperation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Vswitch_changeOperation_feature", "_UI_Vswitch_type"),
				 VmwarePackage.eINSTANCE.getVswitch_ChangeOperation(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Vswitch)object).getName();
