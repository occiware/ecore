...
/**
 * This is the item provider adapter for a {@link org.occiware.clouddesigner.occi.vmware.Hoststorage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HoststorageItemProvider extends StorageItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HoststorageItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHostVolumeNamePropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Host Volume Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHostVolumeNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hoststorage_hostVolumeName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hoststorage_hostVolumeName_feature", "_UI_Hoststorage_type"),
				 VmwarePackage.eINSTANCE.getHoststorage_HostVolumeName(),
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Hoststorage"));
	}
	...
	public String getText(Object object) {
		String label = ((Hoststorage)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_Hoststorage_type") :
			getString("_UI_Hoststorage_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Hoststorage.class)) {
