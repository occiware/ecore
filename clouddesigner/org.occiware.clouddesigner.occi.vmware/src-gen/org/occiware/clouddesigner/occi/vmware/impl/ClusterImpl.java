 ...
 * </p>
 * <ul>
 *   <li>{@link org.occiware.clouddesigner.occi.vmware.impl.ClusterImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ClusterImpl extends ResourceImpl implements Cluster {
	...
	protected EClass eStaticClass() {
		return VmwarePackage.eINSTANCE.getCluster();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VmwarePackage.CLUSTER__NAME, oldName, name));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case VmwarePackage.CLUSTER___ADD_ALL_HOST_SYSTEM:
				addAllHostSystem();
				return null;
			case VmwarePackage.CLUSTER___APPLY_RECOMMENDATION:
				applyRecommendation();
				return null;
			case VmwarePackage.CLUSTER___ENTER_MAINTENANCE_MODE:
