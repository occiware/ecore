		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 InfrastructurePackage.Literals.STORAGE__SIZE,
				 true,
				 false,
				 false,
	...
	protected void addStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Storage_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Storage_state_feature", "_UI_Storage_type"),
				 InfrastructurePackage.Literals.STORAGE__STATE,
				 true,
				 false,
				 false,
