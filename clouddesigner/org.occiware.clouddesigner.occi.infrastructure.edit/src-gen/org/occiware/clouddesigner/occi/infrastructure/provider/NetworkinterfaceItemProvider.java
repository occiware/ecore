		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Networkinterface_interface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Networkinterface_interface_feature", "_UI_Networkinterface_type"),
				 InfrastructurePackage.Literals.NETWORKINTERFACE__INTERFACE,
				 true,
				 false,
				 false,
	...
	protected void addMacPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Networkinterface_mac_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Networkinterface_mac_feature", "_UI_Networkinterface_type"),
				 InfrastructurePackage.Literals.NETWORKINTERFACE__MAC,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Networkinterface_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Networkinterface_state_feature", "_UI_Networkinterface_type"),
				 InfrastructurePackage.Literals.NETWORKINTERFACE__STATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
