...
public class SimulationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimulationPackage.CONTAINS: {
			...
			case SimulationPackage.SIMULATION_RESOURCE: {
				SimulationResource simulationResource = (SimulationResource)theEObject;
				T result = caseSimulationResource(simulationResource);
				if (result == null) result = caseResource(simulationResource);
				if (result == null) result = caseEntity(simulationResource);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseSimulationResource(SimulationResource object) {
		return null;
	}
