 ...
 * </p>
 * <ul>
 *   <li>{@link org.occiware.clouddesigner.occi.cloud.impl.MachineImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MachineImpl extends ComputeImpl implements Machine {
	...
	protected EClass eStaticClass() {
		return CloudPackage.Literals.MACHINE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CloudPackage.MACHINE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CloudPackage.MACHINE__NAME:
				return getName();
		}
