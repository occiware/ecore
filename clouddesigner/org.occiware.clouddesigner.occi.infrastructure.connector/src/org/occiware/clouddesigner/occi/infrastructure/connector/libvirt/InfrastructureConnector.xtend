...
import hypervisor.impl.MachineImpl
 ...
 */
class ExecutableInfrastructureFactory extends HypervisorFactoryImpl {
	private static Logger LOGGER = LoggerFactory.getLogger(typeof(ExecutableInfrastructureFactory))
	...
	def static init() {
		...
		val factory = new ExecutableInfrastructureFactory
...
class LibvirtExecutableModel {
	def static void main(String[] args) {
		...
		ExecutableInfrastructureFactory.init
