...
public class HypervisorPackageImpl extends EPackageImpl implements HypervisorPackage {
	 ...
	 * @see hypervisor.HypervisorPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEEnum(clockEEnum, hypervisor.CLOCK.class, "CLOCK");
		addEEnumLiteral(clockEEnum, hypervisor.CLOCK.OFFSET);

		initEEnum(featuresEEnum, hypervisor.FEATURES.class, "FEATURES");
		addEEnumLiteral(featuresEEnum, hypervisor.FEATURES.ACPI);
		addEEnumLiteral(featuresEEnum, hypervisor.FEATURES.PAE);
		addEEnumLiteral(featuresEEnum, hypervisor.FEATURES.APIC);

		initEEnum(osEEnum, hypervisor.OS.class, "OS");
		addEEnumLiteral(osEEnum, hypervisor.OS.TYPE);
		addEEnumLiteral(osEEnum, hypervisor.OS.BOOT);
		addEEnumLiteral(osEEnum, hypervisor.OS.KERNEL);
		addEEnumLiteral(osEEnum, hypervisor.OS.RAMDISK);
		addEEnumLiteral(osEEnum, hypervisor.OS.CMDLINE);
