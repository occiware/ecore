 ...
 * <ul>
 *   <li>{@link hypervisor.impl.Machine_VirtualBoxImpl#getType <em>Type</em>}</li>
 *   <li>{@link hypervisor.impl.Machine_VirtualBoxImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link hypervisor.impl.Machine_VirtualBoxImpl#getOn_poweroff <em>On poweroff</em>}</li>
 *   <li>{@link hypervisor.impl.Machine_VirtualBoxImpl#getOn_reboot <em>On reboot</em>}</li>
 *   <li>{@link hypervisor.impl.Machine_VirtualBoxImpl#getOn_crash <em>On crash</em>}</li>
 *   <li>{@link hypervisor.impl.Machine_VirtualBoxImpl#getCurrent_memory <em>Current memory</em>}</li>
 *   <li>{@link hypervisor.impl.Machine_VirtualBoxImpl#getVcpu <em>Vcpu</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
